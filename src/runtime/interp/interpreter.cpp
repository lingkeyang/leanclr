...
#define LEANCLR_SWITCH_N(n) goto* in_labels##n[ip[n]];
...
#define LEANCLR_SWITCH_N(n) switch (*(ll::OpCodeValue##n*)(ip + n))
...
// 兼容原有命名
#define LEANCLR_SWITCH0() LEANCLR_SWITCH_N(0)
...
#define LEANCLR_SWITCH1() LEANCLR_SWITCH_N(1)
...
#define LEANCLR_SWITCH2() LEANCLR_SWITCH_N(2)
...
#define LEANCLR_SWITCH3() LEANCLR_SWITCH_N(3)
...
#define LEANCLR_SWITCH4() LEANCLR_SWITCH_N(4)
...
#define LEANCLR_SWITCH5() LEANCLR_SWITCH_N(5)
